...
- The [dummy avatar image](images/avatar.svg) was generated using [TinyGraphs](https://github.com/taironas/tinygraphs) under [MIT](https://github.com/taironas/tinygraphs/blob/master/LICENSE) license.
